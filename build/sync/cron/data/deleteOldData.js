...
async function default_1(conn) {
    ...
    try {
        ...
        await (0, gamma_1.deleteOldData)(conn, common_1.EXCHANGE_ID.BINANCE);
        await (0, gamma_1.deleteOldData)(conn, common_1.EXCHANGE_ID.BITCOM);
        await (0, gamma_1.deleteOldData)(conn, common_1.EXCHANGE_ID.BYBIT);
        await (0, gamma_1.deleteOldData)(conn, common_1.EXCHANGE_ID.DERIBIT);
        await (0, gamma_1.deleteOldData)(conn, common_1.EXCHANGE_ID.OKEX);
